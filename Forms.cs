    ...
    public partial class Forms : Form
    {
        ...
        private void prodaddbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Bahan masuk berhasil ditambahkan");
                Con.Close();
                prodid.Text = "";
                prodname.Text = "";
                quantity.Text = "";
        ...
        private void prodeditbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    SqlCommand command = new SqlCommand(query, Con);
                    command.ExecuteNonQuery();
                    MessageBox.Show("Bahan masuk berhasil di edit");
                    Con.Close();
                    prodid.Text = "";
                    prodname.Text = "";
                    quantity.Text = "";
        ...
        private void proddelbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    SqlCommand command = new SqlCommand(query, Con);
                    command.ExecuteNonQuery();
                    MessageBox.Show("Bahan masuk berhasil dihapus");
                    Con.Close();
                    prodid.Text = "";
                    prodname.Text = "";
                    quantity.Text = "";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    SqlCommand command = new SqlCommand(query, Con);
                    command.ExecuteNonQuery();
                    MessageBox.Show("Jumlah bahan masuk berhasil ditambahkan");
                    Con.Close();
                    prodid.Text = "";
                    prodname.Text = "";
                    quantity.Text = "";
